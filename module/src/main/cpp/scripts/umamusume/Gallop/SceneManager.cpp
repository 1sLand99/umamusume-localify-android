...
static void InitAddress()
{
    ...
    SceneManager_GetCurrentViewController_addr = il2cpp_symbols::get_method_pointer(SceneManager_klass, "GetCurrentViewController", 0);
    SceneManager_GetCurrentSceneController_addr = il2cpp_symbols::get_method_pointer(SceneManager_klass, "GetCurrentSceneController", 0);
