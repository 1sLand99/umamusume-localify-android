...
Il2CppString *GetApplicationServerUrl() {
    ...
    return reinterpret_cast<Il2CppString *(*)()>(il2cpp_class_get_method_from_name(GameDefine, "get_ApplicationServerUrl", 0)->methodPointer)();
}
...
void *MD5CryptoServiceProvider_HashCore_orig = nullptr;

Il2CppArray_t<int8_t> *
MD5CryptoServiceProvider_HashCore_hook(Il2CppObject *_this, Il2CppArray_t<char> *rgb, int ibStart,
                                       int cbSize) {
    LOGD("MD5CryptoServiceProvider_HashCore: %s", string(rgb->vector, rgb->max_length).data());
    return reinterpret_cast<decltype(MD5CryptoServiceProvider_HashCore_hook) *>(MD5CryptoServiceProvider_HashCore_orig)(
            _this, rgb, ibStart, cbSize);
}
...
// the string one looks like will not be called by elsewhere
    ...
    auto MD5CryptoServiceProvider_HashCore_addr = il2cpp_symbols::get_method_pointer("mscorlib.dll",
...
#define ADD_HOOK_NEW(_name_) \
    ...
    ADD_HOOK(MD5CryptoServiceProvider_HashCore);
